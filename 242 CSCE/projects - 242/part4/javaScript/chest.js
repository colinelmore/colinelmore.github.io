const getLifts = async () => {
    const url = "https://colinelmore.github.io/242%20CSCE/projects%20-%20242/part4/json/chest.json";
...
const getLiftItem = (lift) => {
    ...
    img.src = "https://colinelmore.github.io/242%20CSCE/projects%20-%20242/part4/json/chest.json/" + lift.img;
